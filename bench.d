...
void main()
{
    ...
    auto result5 = to!Duration(benchmark!(() => hhres = t9 + t10)(5_000_000)[0]);
    ...
    result5 = to!Duration(benchmark!(() => hhres = t9 - t10)(5_000_000)[0]);
    ...
    result5 = to!Duration(benchmark!(() => hhres = t9 * t10)(1_000_000)[0]);
    ...
    foreach (_; 0 .. 1_000_000)
    {
        arr5 ~= decimal!(HigherHook)(chain(toChars(uniform(-10_000, 10_000)), '0'.repeat(uniform(0, 29))));
    }
    ...
    result5 = to!Duration(benchmark!(() => sort(arr5))(1)[0]);
