...
void main()
{
    ...
    auto result1 = to!Duration(benchmark!(() => hres = t5 + t6)(5_000_000)[0]);

    writeln("BigInt:", "\t\t", result1);
    writeln("Decimal(16):", "\t", result2);
    writeln("Decimal(64):", "\t", result1, "\n");
    ...
    result1 = to!Duration(benchmark!(() => hres = t5 - t6)(5_000_000)[0]);
    ...
    result1 = to!Duration(benchmark!(() => hres = t5 * t6)(1_000_000)[0]);
